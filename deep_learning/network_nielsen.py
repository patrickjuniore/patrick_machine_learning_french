...
class Network(object):
    ...
    def single_step_gradient_descent(self,mini_batch,eta):
        ...
        neuron_gradient= (nabla_w,nabla_b)     
        ...
        for training_input,desired_output in mini_batch:            
            ...
            new_nabla_b, new_nabla_w = self.single_training_example_gradient(example_minibatch,neuron_gradient)
    ...
    def single_training_example_gradient(self,example_minibatch,neuron_gradient):
        """setting PARAMETERS """
        training_input = example_minibatch[0]
        desired_output = example_minibatch[1]
        nabla_w = neuron_gradient[0]
        nabla_b = neuron_gradient[1]
    ...
    def update_network(self,gradient_hyperparameters,neuron_gradient):
        """ setting PARAMETERS"""
